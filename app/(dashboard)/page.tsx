...
export default async function DashboardPage() {
  ...
  return (
    <>
      ...
      <header className="flex items-center gap-4 px-6 py-3 bg-[#182134] border-b border-white/10 shrink-0">
        ...
        <div className="bg-[#334155] border-l-4 border-l-[#2563eb] rounded-xl shadow-sm px-6 py-5 text-center">
          {!allDone && (
            <p className="text-base text-white/60 max-w-xl mx-auto leading-snug mb-3">
              Follow the <span className="text-orange-500 font-medium">orange</span> buttons to set up your workspace — completed steps turn <span className="text-green-500 font-medium">green</span> and the next step appears.
            </p>
          )}
